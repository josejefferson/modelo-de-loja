document.buy.onsubmit = async function (e) {
	e.preventDefault()
	if (!await ask('Finalizar compra', 'Tem certeza que deseja finalizar esta compra? Após clicar em "Sim" seu pedido será enviado para o dono e ele analisará e confirmará se os dados estão corretos para entregar os produtos na sua casa')) return
